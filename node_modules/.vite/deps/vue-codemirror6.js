import {
  isVue2
} from "./chunk-AT5Z25UJ.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-EKU5GMD2.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
...
// ../../node_modules/.pnpm/codemirror@6.0.1_@lezer+common@1.2.2/node_modules/codemirror/dist/index.js
var basicSetup = (() => [
  lineNumbers(),
  highlightActiveLineGutter(),
  highlightSpecialChars(),
...
// ../../node_modules/.pnpm/vue-codemirror6@1.3.4_@lezer+common@1.2.2_vue@3.5.11_typescript@5.6.2_/node_modules/vue-codemirror6/dist/index.es.js
var ie = {
  version: "1.3.4",
  date: "2024-07-11T09:11:00.140Z"
};
var he = ie;
var le = (e) => e ? Object.entries(e).reduce((l, [i, u]) => (i = i.charAt(0).toUpperCase() + i.slice(1), i = `on${i}`, { ...l, [i]: u }), {}) : {};
function B(e, l = {}, i) {
  if (isVue2)
    return h(e, l, i);
    ...
    const i = ref(), u = ref(e.modelValue), t = shallowRef(new EditorView()), d = computed({
      ...
      return [
        ...
        EditorView.updateListener.of((o) => {
          var _a;
          l.emit("focus", t.value.hasFocus), S.value = (_a = t.value.state.doc) == null ? void 0 : _a.length, !(o.changes.empty || !o.docChanged) && (e.linter && (e.forceLinting && forceLinting(t.value), h2.value = e.linter(t.value).length), l.emit("update", o));
        }),
...
`) === a)
      ...
      ), a = i.value.childNodes[0].innerText.trim()), t.value = new EditorView({
        parent: i.value,
