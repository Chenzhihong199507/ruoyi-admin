...
// ../../node_modules/.pnpm/vxe-pc-ui@4.2.13/node_modules/vxe-pc-ui/es/tooltip/src/tooltip.js
...
var tooltip_default = defineComponent({
  ...
  setup(props, context) {
    ...
    const renderVN = () => {
      ...
      return h("div", Object.assign({ ref: refElem, class: ["vxe-table--tooltip-wrapper", `theme--${theme}`, popupClassName ? import_xe_utils.default.isFunction(popupClassName) ? popupClassName({ $tooltip: $xeTooltip }) : popupClassName : "", {
        [`size--${vSize}`]: vSize,
...
//# sourceMappingURL=chunk-5GMTKZB2.js.map
