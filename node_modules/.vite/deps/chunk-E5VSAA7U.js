...
// ../../node_modules/.pnpm/vxe-pc-ui@4.2.13/node_modules/vxe-pc-ui/es/input/src/input.js
var import_xe_utils3 = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-pc-ui@4.2.13/node_modules/vxe-pc-ui/es/date-picker/src/util.js
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.2.13/node_modules/vxe-pc-ui/es/number-input/src/util.js
var import_xe_utils2 = __toESM(require_xe_utils());
function handleNumber(val) {
  return import_xe_utils2.default.isString(val) ? val.replace(/,/g, "") : val;
}
function toFloatValueFixed(inputValue, digitsValue) {
  if (/^-/.test("" + inputValue)) {
    return import_xe_utils2.default.toFixed(import_xe_utils2.default.ceil(inputValue, digitsValue), digitsValue);
  }
  return import_xe_utils2.default.toFixed(import_xe_utils2.default.floor(inputValue, digitsValue), digitsValue);
}
...
var input_default = defineComponent({
  ...
  setup(props, context) {
    ...
    const parseDate = (value, format) => {
      ...
      return import_xe_utils3.default.toStringDate(value, format);
    };
    const computeBtnTransfer = computed(() => {
      const { transfer } = props;
      if (transfer === null) {
        const globalTransfer = getConfig().input.transfer;
        if (import_xe_utils3.default.isBoolean(globalTransfer)) {
    ...
    const computeInpMaxLength = computed(() => {
      ...
      if (isNumType) {
        if (!import_xe_utils3.default.toNumber(maxLen)) {
          return 16;
        }
      }
      return maxLen;
    ...
    const computeInputCount = computed(() => {
      return import_xe_utils3.default.getSize(reactData.inputValue);
    });
    const computeIsCountError = computed(() => {
      const inputCount = computeInputCount.value;
      const inpMaxLength = computeInpMaxLength.value;
      return inpMaxLength && inputCount > import_xe_utils3.default.toNumber(inpMaxLength);
    });
    ...
    const computeDigitsValue = computed(() => {
      return import_xe_utils3.default.toInteger(props.digits) || 1;
    });
    const computeStepValue = computed(() => {
      ...
      if (type === "integer") {
        return import_xe_utils3.default.toInteger(step) || 1;
      } else if (type === "float") {
        return import_xe_utils3.default.toNumber(step) || 1 / Math.pow(10, digitsValue);
      }
      return import_xe_utils3.default.toNumber(step) || 1;
    });
    ...
    const computeDateStartTime = computed(() => {
      return props.startDate ? import_xe_utils3.default.toStringDate(props.startDate) : null;
    });
    const computeDateEndTime = computed(() => {
      return props.endDate ? import_xe_utils3.default.toStringDate(props.endDate) : null;
    });
    ...
    const computeDateListValue = computed(() => {
      ...
      if (multiple && modelValue && isDatePickerType) {
        return import_xe_utils3.default.toValueString(modelValue).split(",").map((item) => {
          const date = parseDate(item, dateValueFormat);
          if (import_xe_utils3.default.isValidDate(date)) {
            return date;
          }
          return null;
        });
    ...
    const computeDateMultipleValue = computed(() => {
      ...
      const dateValueFormat = computeDateValueFormat.value;
      return dateListValue.map((date) => import_xe_utils3.default.toDateString(date, dateValueFormat));
    });
    const computeDateMultipleLabel = computed(() => {
      const dateListValue = computeDateListValue.value;
      const dateLabelFormat = computeDateLabelFormat.value;
      return dateListValue.map((date) => import_xe_utils3.default.toDateString(date, dateLabelFormat)).join(", ");
    });
    ...
    const computeDateTimeLabel = computed(() => {
      ...
      if (datetimePanelValue) {
        return import_xe_utils3.default.toDateString(datetimePanelValue, hasTimeSecond ? "HH:mm:ss" : "HH:mm");
      }
      return "";
    });
    ...
    const computeYearList = computed(() => {
      ...
      if (selectMonth && currentDate) {
        ...
        for (let index = -4; index < yearSize + 4; index++) {
          const date = import_xe_utils3.default.getWhatYear(startYearDate, index, "first");
    ...
    const computeFirstDayOfWeek = computed(() => {
      ...
      return import_xe_utils3.default.toNumber(import_xe_utils3.default.isNumber(startDay) || import_xe_utils3.default.isString(startDay) ? startDay : startWeek);
    });
    ...
    const computeYearDatas = computed(() => {
      const yearList = computeYearList.value;
      return import_xe_utils3.default.chunk(yearList, 4);
    });
    const computeQuarterList = computed(() => {
      ...
      if (selectMonth && currentDate) {
        ...
        const firstYear = import_xe_utils3.default.getWhatYear(selectMonth, 0, "first");
        const selFullYear = firstYear.getFullYear();
        for (let index = -2; index < quarterSize - 2; index++) {
          const date = import_xe_utils3.default.getWhatQuarter(firstYear, index);
          const itemFullYear = date.getFullYear();
    ...
    const computeQuarterDatas = computed(() => {
      ...
      return import_xe_utils3.default.chunk(quarterList, 2);
    });
    const computeMonthList = computed(() => {
      ...
      if (selectMonth && currentDate) {
        ...
        const selFullYear = import_xe_utils3.default.getWhatYear(selectMonth, 0, "first").getFullYear();
        for (let index = -4; index < monthSize - 4; index++) {
          const date = import_xe_utils3.default.getWhatYear(selectMonth, 0, index);
          const itemFullYear = date.getFullYear();
    ...
    const computeMonthDatas = computed(() => {
      ...
      return import_xe_utils3.default.chunk(monthList, 4);
    });
    const computeDayList = computed(() => {
      ...
      if (selectMonth && currentDate) {
        ...
        const startDayDate = new Date(import_xe_utils3.default.getWhatDay(selectMonth, prevOffsetDate).getTime() + dateHMSTime);
        for (let index = 0; index < 42; index++) {
          const date = import_xe_utils3.default.getWhatDay(startDayDate, index);
          const itemFullYear = date.getFullYear();
          const itemMonth = date.getMonth();
    ...
    const computeDayDatas = computed(() => {
      ...
      return import_xe_utils3.default.chunk(dayList, 7);
    });
    const computeWeekDates = computed(() => {
      ...
      return dayDatas.map((list) => {
        ...
        const item = {
          ...
          isNow: false,
          isNext: false,
          label: import_xe_utils3.default.getYearWeek(firstItem.date, firstDayOfWeek)
        };
    ...
    const computeNumValue = computed(() => {
      ...
      const isNumType = computeIsNumType.value;
      if (isNumType) {
        return type === "integer" ? import_xe_utils3.default.toInteger(handleNumber(inputValue)) : import_xe_utils3.default.toNumber(handleNumber(inputValue));
      }
      return 0;
    });
    const computeIsDisabledSubtractNumber = computed(() => {
      ...
      if ((inputValue || inputValue === 0) && isNumType && min !== null) {
        return numValue <= import_xe_utils3.default.toNumber(min);
      }
      return false;
    });
    const computeIsDisabledAddNumber = computed(() => {
      ...
      if ((inputValue || inputValue === 0) && isNumType && max !== null) {
        return numValue >= import_xe_utils3.default.toNumber(max);
      }
      return false;
    });
    const getNumberValue = (val) => {
      ...
      const inpMaxLength = computeInpMaxLength.value;
      const digitsValue = computeDigitsValue.value;
      const restVal = type === "float" ? toFloatValueFixed(val, digitsValue) : import_xe_utils3.default.toValueString(val);
      if (exponential && (val === restVal || import_xe_utils3.default.toValueString(val).toLowerCase() === import_xe_utils3.default.toNumber(restVal).toExponential())) {
        return val;
      }
    ...
    const handleChange = (value, evnt) => {
      ...
      if (import_xe_utils3.default.toValueString(props.modelValue) !== value) {
    ...
    const dateParseValue = (value) => {
      ...
      if (import_xe_utils3.default.isValidDate(dValue)) {
        dLabel = import_xe_utils3.default.toDateString(dValue, dateLabelFormat, { firstDay: firstDayOfWeek });
        if (dateLabelFormat && type === "week") {
          const firstWeekDate = import_xe_utils3.default.getWhatWeek(dValue, 0, firstDayOfWeek, firstDayOfWeek);
    ...
    const validMaxNum = (num) => {
      return props.max === null || import_xe_utils3.default.toNumber(num) <= import_xe_utils3.default.toNumber(props.max);
    };
    const validMinNum = (num) => {
      return props.min === null || import_xe_utils3.default.toNumber(num) >= import_xe_utils3.default.toNumber(props.min);
    };
    const dateRevert = () => {
      reactData.inputValue = props.multiple ? computeDateMultipleLabel.value : reactData.datePanelLabel;
    };
    const dateCheckMonth = (date) => {
      const month = import_xe_utils3.default.getWhatMonth(date, 0, "first");
      if (!import_xe_utils3.default.isEqual(month, reactData.selectMonth)) {
    ...
    const dateChange = (date) => {
      ...
      const firstDayOfWeek = computeFirstDayOfWeek.value;
      if (props.type === "week") {
        const sWeek = import_xe_utils3.default.toNumber(props.selectDay);
        date = import_xe_utils3.default.getWhatWeek(date, 0, sWeek, firstDayOfWeek);
      } else if (isDateTimeType) {
        date.setHours(datetimePanelValue.getHours());
        date.setMinutes(datetimePanelValue.getMinutes());
        date.setSeconds(datetimePanelValue.getSeconds());
      }
      const inpVal = import_xe_utils3.default.toDateString(date, dateValueFormat, { firstDay: firstDayOfWeek });
      dateCheckMonth(date);
      if (multiple) {
        ...
        if (isDateTimeType) {
          const dateListValue = [...computeDateListValue.value];
          const datetimeRest = [];
          const eqIndex = import_xe_utils3.default.findIndexOf(dateListValue, (val) => import_xe_utils3.default.isDateSame(date, val, "yyyyMMdd"));
          if (eqIndex === -1) {
          ...
          handleChange(datetimeRest.map((date2) => import_xe_utils3.default.toDateString(date2, dateValueFormat)).join(","), { type: "update" });
        } else {
          if (dateMultipleValue.some((val) => import_xe_utils3.default.isEqual(val, inpVal))) {
            handleChange(dateMultipleValue.filter((val) => !import_xe_utils3.default.isEqual(val, inpVal)).join(","), { type: "update" });
          } else {
            handleChange(dateMultipleValue.concat([inpVal]).join(","), { type: "update" });
          }
        }
      } else {
        if (!import_xe_utils3.default.isEqual(modelValue, inpVal)) {
    ...
    const afterCheckValue = () => {
      ...
      if (!inputReadonly) {
        if (isNumType) {
          if (inputValue) {
            let inpNumVal = type === "integer" ? import_xe_utils3.default.toInteger(handleNumber(inputValue)) : import_xe_utils3.default.toNumber(handleNumber(inputValue));
            ...
            if (exponential) {
              const inpStringVal = import_xe_utils3.default.toValueString(inputValue).toLowerCase();
              if (inpStringVal === import_xe_utils3.default.toNumber(inpNumVal).toExponential()) {
          ...
          if (inputValue) {
            ...
            if (import_xe_utils3.default.isValidDate(inpDateVal)) {
              if (type === "time") {
                inpDateVal = import_xe_utils3.default.toDateString(inpDateVal, dateLabelFormat);
                ...
                if (type === "datetime") {
                  const dateValue = computeDateValue.value;
                  if (inputValue !== import_xe_utils3.default.toDateString(dateValue, dateLabelFormat) || inputValue !== import_xe_utils3.default.toDateString(inpDateVal, dateLabelFormat)) {
                    isChange = true;
                ...
                reactData.inputValue = import_xe_utils3.default.toDateString(inpDateVal, dateLabelFormat, { firstDay: firstDayOfWeek });
                if (isChange) {
    ...
    const numberChange = (isPlus, evnt) => {
      ...
      const numValue = type === "integer" ? import_xe_utils3.default.toInteger(handleNumber(inputValue)) : import_xe_utils3.default.toNumber(handleNumber(inputValue));
      const newValue = isPlus ? import_xe_utils3.default.add(numValue, stepValue) : import_xe_utils3.default.subtract(numValue, stepValue);
      let restNum;
    ...
    const dateMonthHandle = (date, offsetMonth) => {
      reactData.selectMonth = import_xe_utils3.default.getWhatMonth(date, offsetMonth, "first");
    };
    const dateNowHandle = () => {
      const currentDate = import_xe_utils3.default.getWhatDay(Date.now(), 0, "first");
    ...
    const datePrevEvent = (evnt) => {
      ...
      if (!isDisabledPrevDateBtn) {
        let viewDate;
        if (type === "year") {
          viewDate = import_xe_utils3.default.getWhatYear(selectMonth, -yearSize, "first");
        } else if (type === "month" || type === "quarter") {
          if (datePanelType === "year") {
            viewDate = import_xe_utils3.default.getWhatYear(selectMonth, -yearSize, "first");
          } else {
            viewDate = import_xe_utils3.default.getWhatYear(selectMonth, -1, "first");
          }
        } else {
          if (datePanelType === "year") {
            viewDate = import_xe_utils3.default.getWhatYear(selectMonth, -yearSize, "first");
            ...
            viewDate = import_xe_utils3.default.getWhatMonth(selectMonth, -1, "first");
          }
        }
    ...
    const dateMoveDay = (offsetDay) => {
      if (!isDateDisabled({ date: offsetDay })) {
        const dayList = computeDayList.value;
        if (!dayList.some((item) => import_xe_utils3.default.isDateSame(item.date, offsetDay, "yyyyMMdd"))) {
    ...
    const dateMoveYear = (offsetYear) => {
      if (!isDateDisabled({ date: offsetYear })) {
        const yearList = computeYearList.value;
        if (!yearList.some((item) => import_xe_utils3.default.isDateSame(item.date, offsetYear, "yyyy"))) {
    ...
    const dateMoveQuarter = (offsetQuarter) => {
      if (!isDateDisabled({ date: offsetQuarter })) {
        const quarterList = computeQuarterList.value;
        if (!quarterList.some((item) => import_xe_utils3.default.isDateSame(item.date, offsetQuarter, "yyyyq"))) {
    ...
    const dateMoveMonth = (offsetMonth) => {
      if (!isDateDisabled({ date: offsetMonth })) {
        const monthList = computeMonthList.value;
        if (!monthList.some((item) => import_xe_utils3.default.isDateSame(item.date, offsetMonth, "yyyyMM"))) {
      ...
      if (isDateTimeType) {
        ...
        if (multiple) {
          ...
          if (isDateTimeType) {
            ...
            handleChange(datetimeRest.map((date) => import_xe_utils3.default.toDateString(date, dateValueFormat)).join(","), { type: "update" });
          } else {
    ...
    const dateOffsetEvent = (evnt) => {
      ...
      if (isActivated) {
        ...
        const isDwArrow = globalEvents.hasKey(evnt, GLOBAL_EVENT_KEYS.ARROW_DOWN);
        if (datePanelType === "year") {
          let offsetYear = import_xe_utils3.default.getWhatYear(datePanelValue || Date.now(), 0, "first");
          if (isLeftArrow) {
            offsetYear = import_xe_utils3.default.getWhatYear(offsetYear, -1);
          } else if (isUpArrow) {
            offsetYear = import_xe_utils3.default.getWhatYear(offsetYear, -4);
          ...
          let offsetQuarter = import_xe_utils3.default.getWhatQuarter(datePanelValue || Date.now(), 0, "first");
          if (isLeftArrow) {
            offsetQuarter = import_xe_utils3.default.getWhatQuarter(offsetQuarter, -1);
          } else if (isUpArrow) {
            offsetQuarter = import_xe_utils3.default.getWhatQuarter(offsetQuarter, -2);
          } else if (isRightArrow) {
            offsetQuarter = import_xe_utils3.default.getWhatQuarter(offsetQuarter, 1);
          } else if (isDwArrow) {
            offsetQuarter = import_xe_utils3.default.getWhatQuarter(offsetQuarter, 2);
          ...
          let offsetMonth = import_xe_utils3.default.getWhatMonth(datePanelValue || Date.now(), 0, "first");
          if (isLeftArrow) {
            offsetMonth = import_xe_utils3.default.getWhatMonth(offsetMonth, -1);
          } else if (isUpArrow) {
            offsetMonth = import_xe_utils3.default.getWhatMonth(offsetMonth, -4);
          } else if (isRightArrow) {
            offsetMonth = import_xe_utils3.default.getWhatMonth(offsetMonth, 1);
          } else if (isDwArrow) {
            offsetMonth = import_xe_utils3.default.getWhatMonth(offsetMonth, 4);
          ...
          let offsetDay = datePanelValue || import_xe_utils3.default.getWhatDay(Date.now(), 0, "first");
          const firstDayOfWeek = computeFirstDayOfWeek.value;
          if (isLeftArrow) {
            offsetDay = import_xe_utils3.default.getWhatDay(offsetDay, -1);
          } else if (isUpArrow) {
            offsetDay = import_xe_utils3.default.getWhatWeek(offsetDay, -1, firstDayOfWeek);
          } else if (isRightArrow) {
            offsetDay = import_xe_utils3.default.getWhatDay(offsetDay, 1);
          } else if (isDwArrow) {
            offsetDay = import_xe_utils3.default.getWhatWeek(offsetDay, 1, firstDayOfWeek);
    ...
    const dateOpenPanel = () => {
      ...
      reactData.currentDate = import_xe_utils3.default.getWhatDay(Date.now(), 0, "first");
      if (dateValue) {
      ...
      if (isDateTimeType) {
        reactData.datetimePanelValue = reactData.datePanelValue || import_xe_utils3.default.getWhatDay(Date.now(), 0, "first");
        nextTick(() => {
          const timeBodyElem = refInputTimeBody.value;
          import_xe_utils3.default.arrayEach(timeBodyElem.querySelectorAll("li.is--selected"), (elem) => {
            updateTimePos(elem);
          });
        });
      }
    ...
    const renderDateLabel = (item, label) => {
      ...
      if (festivalMethod) {
        ...
        const festivalItem = festivalRest ? import_xe_utils3.default.isString(festivalRest) ? { label: festivalRest } : festivalRest : {};
        const extraItem = festivalItem.extra ? import_xe_utils3.default.isString(festivalItem.extra) ? { label: festivalItem.extra } : festivalItem.extra : null;
        const labels = [
          h("span", {
            ...
            }, import_xe_utils3.default.toValueString(extraItem.label))
          ] : [`${label || ""}`])
        ];
        const festivalLabel = festivalItem.label;
        if (festivalLabel) {
          const festivalLabels = import_xe_utils3.default.toValueString(festivalLabel).split(",");
          labels.push(h("span", {
            ...
            return h("tr", rows.map((item) => {
              return h("td", {
                class: {
                  ...
                  "is--selected": multiple ? dateListValue.some((val) => import_xe_utils3.default.isDateSame(val, item.date, matchFormat)) : import_xe_utils3.default.isDateSame(dateValue, item.date, matchFormat),
                  "is--hover": import_xe_utils3.default.isDateSame(datePanelValue, item.date, matchFormat)
                },
      ...
      return [
        h("table", {
          ...
          h("tbody", weekDates.map((rows) => {
            const isSelected = multiple ? rows.some((item) => dateListValue.some((val) => import_xe_utils3.default.isDateSame(val, item.date, matchFormat))) : rows.some((item) => import_xe_utils3.default.isDateSame(dateValue, item.date, matchFormat));
            const isHover = rows.some((item) => import_xe_utils3.default.isDateSame(datePanelValue, item.date, matchFormat));
            return h("tr", rows.map((item) => {
              return h("td", {
                class: {
                  "is--prev": item.isPrev,
    ...
    const renderSuffixIcon = () => {
      ...
      return isClearable || suffixSlot || suffixIcon || isExtraBtn ? h("div", {
        class: ["vxe-input--suffix", {
          "is--clear": isClearable && !isDisabled && !(inputValue === "" || import_xe_utils3.default.eqNull(inputValue))
        }]
      }, [
        isClearable ? h("div", {
    ...
    const renderVN = () => {
      ...
      return h("div", {
        ...
        class: ["vxe-input", `type--${type}`, className, {
          ...
          "show--clear": isClearable && !isDisabled && !(inputValue === "" || import_xe_utils3.default.eqNull(inputValue))
        }],
        spellcheck: false
      }, [
...
//# sourceMappingURL=chunk-E5VSAA7U.js.map
